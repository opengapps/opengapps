  ...
  case "$1" in
    ...
    defaultetc)               packagetype="Core";
                              if [ "$API" -ge "29" ]; then # Specific permission files for Android 10.0
                                packagefiles="etc/default-permissions/default-permissions.xml etc/default-permissions/opengapps-permissions.xml etc/permissions/privapp-permissions-google.xml etc/permissions/privapp-permissions-google-p.xml etc/permissions/privapp-permissions-google-ps.xml etc/permissions/split-permissions-google.xml etc/preferred-apps/google.xml etc/sysconfig/google-hiddenapi-package-whitelist.xml etc/sysconfig/google.xml etc/sysconfig/google_build.xml etc/sysconfig/google_exclusives_enable.xml"
    ...
    setupwizarddefault)       packagetype="Core"; packagename="com.google.android.setupwizard.default"; packagetarget="priv-app/SetupWizard";;  # PixelSetupWizard on Pixels
