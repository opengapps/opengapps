...
form(
    ...
    "remove",     "Choose apps which you want to remove",        "",                                         "group",
      ...
      "CMAccount",     "<b>CyanogenMod Account [obsolete]</b>",       "",                      "check",
      "LAudioFX",     "<b>LineageOS AudioFX</b>",       "",                      "check",
      "LBugReport",     "<b>LineageOS Bug Report</b>",       "",                      "check",
      "LFileManager",     "<b>LineageOS File Manager</b>",       "",                      "check",
      "LMusic",     "<b>LineageOS Music</b>",       "",                      "check",
      "LSetupWizard",     "<b>LineageOS Setup Wizard</b>",       "",                      "check",
      "LUpdater",     "<b>LineageOS Updater</b>",       "",                      "check",
      "LWallpapers",     "<b>LineageOS Wallpapers</b>",       "",                      "check",
