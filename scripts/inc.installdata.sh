...
clock_sys_msg="WARNING: Google Desk Clock has/will not be installed as requested. Google Desk\nClock can only be installed during a Clean Install or as an update to an\nexisting GApps Installation.\n";
