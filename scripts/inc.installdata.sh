...
non_open_gapps_msg="NOTE: The installer detected that you already have other GApps installed. The\ninstaller will now continue, but please be aware that there could be problems.";
