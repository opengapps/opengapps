...
no_awk_message="INSTALLATION FAILURE: The installer detected that your recovery does not have awk.\nPlease update your recovery or switch to another one like TWRP."
